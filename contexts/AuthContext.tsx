...
// Fix: Import UserRole to be used in the new switchUserRole function.
import { User, UserRole } from '../types.ts';
import { login as apiLogin, register as apiRegister, loginWithGoogle as apiLoginWithGoogle, completeUserProfile } from '../services/api.ts';
...
interface AuthContextType {
  ...
  // Fix: Add switchUserRole to the context type to be available in useAuth hook.
  switchUserRole: (role: UserRole) => void;
}

export const AuthContext = createContext<AuthContextType | undefined>(undefined);

// Fix: Added a map of mock users for the dev-only role switcher.
// This data is based on the mock data provided in the project files.
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Fix: Implement the switchUserRole function for the DevRoleNavigator component.
